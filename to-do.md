...
|---|---|---|
| **M1 · Оракул** | ✅ готово | 108 размеченных ожиданий, 19 из 20 правил реестра |
...
| **M5 · Кастомы и кандидаты** | ⬜ не начато | — |
| **M6 · Агентная обёртка** | ⬜ вне текущего объёма | — |
...
### M5 · Знание о ките и кастомные компоненты `~2 дня` — шаги 10, 11, 12 ⬅ следующая
...
### M6 · Агентная обёртка `~1.5 дня` — шаги 13–16
